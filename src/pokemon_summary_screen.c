...
static void BufferMonSkills(void)
{
    ...
    // LOTAD: GetMonAbility (not a raw GetAbilityBySpecies call) so the summary screen shows the
    // real ability when an All-Gen ability override is set on this mon.
