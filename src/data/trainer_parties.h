...
static const struct TrainerMonNoItemCustomMoves sParty_RivalPokemonTowerBulbasaur[] = {
    {
        ...
        .lvl = 25,
        .species = SPECIES_PIDGEOTTO,
        .moves = {MOVE_SAND_ATTACK, MOVE_GUST, MOVE_QUICK_ATTACK, MOVE_WHIRLWIND},
    },
    {
        .iv = 100,
        .lvl = 23,
        .species = SPECIES_GYARADOS,
        .moves = {MOVE_THRASH, MOVE_BITE, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 100,
        .lvl = 22,
    ...
    },
    {
        ...
        .lvl = 20,
        .species = SPECIES_KADABRA,
        .moves = {MOVE_KINESIS, MOVE_CONFUSION, MOVE_CONFUSION, MOVE_DISABLE},
    },
    {
        .iv = 100,
        .lvl = 25,
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalSilphBulbasaur[] = {
    ...
    },
    {
        ...
        .lvl = 38,
        .species = SPECIES_GYARADOS,
        .moves = {MOVE_BITE, MOVE_DRAGON_RAGE, MOVE_LEER, MOVE_TWISTER},
    },
    {
        .iv = 100,
        .lvl = 35,
        .species = SPECIES_GROWLITHE,
        .moves = {MOVE_LEER, MOVE_ODOR_SLEUTH, MOVE_TAKE_DOWN, MOVE_FLAME_WHEEL},
    },
    {
        .iv = 100,
        .lvl = 35,
        .species = SPECIES_ALAKAZAM,
        .moves = {MOVE_REFLECT, MOVE_RECOVER, MOVE_FUTURE_SIGHT, MOVE_CALM_MIND},
    },
    {
        .iv = 150,
        .lvl = 40,
